-- Story 2.2: sync_character_profile() e sync_character_skill()
-- Mesmo padrao de seguranca da Story 2.1 (SECURITY DEFINER, client sem GRANT direto).
...
grant execute on function sync_character_profile(uuid) to authenticated;
...
grant execute on function sync_character_skill(uuid, text) to authenticated;
